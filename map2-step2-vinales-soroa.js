// map2-step2-vinales-soroa.js
// CUBA2 with calibrated positions - STEP 2: Adding Viñales → Soroa route
// Now drawing TWO routes: Habana → Viñales + Viñales → Soroa

import { latLngToSVG, getCityYAdjustment, getCityLabelPosition } from './projection-config.js';

window.addEventListener('DOMContentLoaded', () => {
  console.log('map2-step2-vinales-soroa.js loaded (CUBA2 - Step 2: + Viñales → Soroa)');
  ...
  setTimeout(() => {
    ...
    const exportSVG = (svgDoc) => {
      ...
      link.href = url;
      link.download = 'cuba-map2-step2-vinales-soroa.svg';
      link.click();
    ...
    const initializeMap = () => {
      console.log('initializeMap called (CUBA2 Step 2: Habana → Viñales → Soroa)');
      ...
      // Load GeoJSON data and add markers + TWO routes
