// map2-step1-habana-vinales.js
// CUBA2 with calibrated positions - STEP 1: Habana → Viñales route only
// Testing route drawing with calibrated city positions

import { latLngToSVG, getCityYAdjustment, getCityLabelPosition } from './projection-config.js';

window.addEventListener('DOMContentLoaded', () => {
  console.log('map2-step1-habana-vinales.js loaded (CUBA2 - Step 1: Habana → Viñales)');
  ...
  setTimeout(() => {
    ...
    const exportSVG = (svgDoc) => {
      ...
      link.href = url;
      link.download = 'cuba-map2-step1-habana-vinales.svg';
      link.click();
    ...
    const initializeMap = () => {
      console.log('initializeMap called (CUBA2 Step 1: Habana → Viñales)');
      ...
      // Load GeoJSON data and add markers + ONE route
      fetch('cuba-locations-geojson.json')
        ...
        .then((data) => {
          ...
          // STEP 1: Draw ONLY Habana → Viñales route
