...
**** Next Steps
1. Open calibrate-projection.html in browser
2. Adjust bounds/offset until all cities appear on land
3. Copy calibrated values back to projection-config.js
4. Test with index2-markers-only.html
5. Once positioning is correct, add routes back to map2.js
